...
/* original:            'chart.colors':                 ['red','#0f0','blue','pink','orange','cyan','black','white','green','magenta'],*/
            'chart.colors':                 ['#A13BCC','#0f0','blue','pink','orange','cyan','black','white','green','magenta'],
...
/*            'chart.shadow.color':           '#aaa',  // Gradients aren't supported for this color*/
            'chart.shadow.color':           '#000000',  // Gradients aren't supported for this color
/*            'chart.shadow.offsetx':         0, */
/*            'chart.shadow.offsety':         0, */
            'chart.shadow.offsetx':         10,
            'chart.shadow.offsety':         10,
